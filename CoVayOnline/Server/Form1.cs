...
namespace Server
{
    public partial class Form1 : Form
    {
        ...
        SqlCommand command;
        string sourse = @"Data Source=MSI\MISASME2017;Initial Catalog=QLTaiKhoan;Integrated Security=True";
        ...
        private void btnListenSignIn_Click(object sender, EventArgs e)
        {
            CheckForIllegalCrossThreadCalls = false;
